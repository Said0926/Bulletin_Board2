...
> **Эксперимент:** этот проект создан с помощью [Claude Code](https://claude.ai/code) примерно за 2 часа — как сравнение с [версией, которую я писал сам](https://github.com/Said0926/Bulletin_Board.git) в течение недели. Одна задача, два подхода, разный масштаб затраченного времени.
